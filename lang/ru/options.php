...
<fieldset title='Обратная связь'>
	 ...
	 <a href='http://www.data-studio.ru/services/' target='_blank' title='Услуги по созданию и продвижению сайтов'>Разработка, продвижение,</a> а также <a href='http://www.data-studio.ru/technical-support/' target='_blank'>техническая поддержка:</a> <br>
	 <a href='http://www.data-studio.ru/market/' title='Используя наши тиражные решения вы сможете расширить охват вашей целевой аудитории и получить дополнительных клиентов'>Узнайте как увеличить прибыль с сайта</a>&nbsp; 8 800 333-84-52; <a href='mailto:design@data-studio.ru' title='Электронная почта Веб студии АКРИТ'>design@data-studio.ru</a> <br>
		 Заказ <a href='http://www.data-studio.ru/technical-support/' target='_blank' title='Если у вас возникли какие то сложности или задачи по сайту обращайтесь по данной ссылке'>доработок и&nbsp;техподдержка сайтов через службу Технической поддержки</a>
</fieldset>
";
...
$MESS["A_SUPPORT_URL"] = "http://www.data-studio.ru/support/?show_wizard=Y";
?>