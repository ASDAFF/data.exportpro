...
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_TITLE'] = 'Мастер создания профилей';
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_NEXT'] = 'Продолжить';
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_PREV'] = 'Вернуться';
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_SUBMIT'] = 'Создать профили для выбранных торговых площадок';
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_CLOSE'] = 'Закрыть';
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_FINISH'] = 'Завершить';
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_NO_PLUGIN'] = 'Выберите хотя бы один формат выгрузки';
$MESS['ACRIT_EXP_POPUP_WIZARD_QUICK_START_NO_IBLOCK'] = 'Выберите хотя бы один инфоблок';
...
$MESS['ACRIT_EXP_HEADER_LOCKED'] = 'Блок.';
...
// Filename conflicts
$MESS['ACRIT_EXP_FILENAME_CONFLICTS_TITLE'] = 'Имеются конфликты имен файлов (разные профили выгружают в один и тот же файл)';
$MESS['ACRIT_EXP_FILENAME_CONFLICTS_ITEM'] = '<li>Файл #FILENAME# используется в профилях #PROFILES#</li>';
$MESS['ACRIT_EXP_FILENAME_CONFLICTS_NOTICE'] = '<div>:</div><div>#HTML#</div>';
