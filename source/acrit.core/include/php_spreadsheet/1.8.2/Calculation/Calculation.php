    ...
    public function setLocale($locale)
    {
        ...
        if (in_array($language, self::$validLocaleLanguages)) {
            ...
            if ($locale != 'en_us') {
                ...
                $configFile = __DIR__ . '/locale/locale_' . str_replace('_', DIRECTORY_SEPARATOR, $locale) . DIRECTORY_SEPARATOR . 'config';
                if (!file_exists($configFile)) {
                    $configFile = __DIR__ . '/locale/locale_' . $language . DIRECTORY_SEPARATOR . 'config';
                }
                if (file_exists($configFile)) {
