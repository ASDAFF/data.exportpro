...
class Calculation
{
    ...
    private static function loadLocales()
    {
        ...
        foreach (glob($localeFileDirectory . '*', GLOB_ONLYDIR) as $filename) {
            ...
            if ($filename != 'locale_en') {
                self::$validLocaleLanguages[] = end(explode('_', $filename));
            }
        }
    }
    ...
    public function setLocale($locale)
    {
        ...
        if (in_array($language, self::$validLocaleLanguages)) {
            ...
            if ($locale != 'en_us') {
                ...
                $functionNamesFile = __DIR__ . '/locale/locale_' . str_replace('_', DIRECTORY_SEPARATOR, $locale) . DIRECTORY_SEPARATOR . 'functions';
                if (!file_exists($functionNamesFile)) {
                    //    If there isn't a locale specific function file, look for a language specific function file
                    $functionNamesFile = __DIR__ . '/locale/locale_' . $language . DIRECTORY_SEPARATOR . 'functions';
                    if (!file_exists($functionNamesFile)) {
                        return false;
                    }
                }
