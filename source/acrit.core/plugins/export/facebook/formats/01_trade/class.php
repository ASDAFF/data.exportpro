...
class FacebookTrade extends Facebook {

   CONST DATE_UPDATED = '2018-09-19';
   CONST CATEGORIES_TXT_URL = 'http://www.google.com/basepages/producttype/taxonomy-with-ids.ru-RU.txt';
   ...
   public function updateCategories($intProfileID) {
      ...
      $strCategories = HttpRequest::get(static::CATEGORIES_TXT_URL, array('TIMEOUT' => 20));
   ...
   public function getFields($intProfileID, $intIBlockID, $bAdmin = false) {
      ...
      $arResult[] = new Field(array(
          'CODE' => 'INVENTORY',
          'DISPLAY_CODE' => 'inventory',
          'NAME' => static::getMessage('FIELD_INVENTORY_NAME'),
          'SORT' => 1420,
          'DESCRIPTION' => static::getMessage('FIELD_INVENTORY_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'SHIPPING_PROFILE_ID',
          'DISPLAY_CODE' => 'shipping_profile_id',
          'NAME' => static::getMessage('FIELD_SHIPPING_PROFILE_ID_NAME'),
          'SORT' => 1430,
          'DESCRIPTION' => static::getMessage('FIELD_SHIPPING_PROFILE_ID_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'RICH_TEXT_DESCRIPTION',
          'DISPLAY_CODE' => 'rich_text_description',
          'NAME' => static::getMessage('FIELD_RICH_TEXT_DESCRIPTION_NAME'),
          'SORT' => 1440,
          'DESCRIPTION' => static::getMessage('FIELD_RICH_TEXT_DESCRIPTION_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'RETURN_POLICY_INFO',
          'DISPLAY_CODE' => 'return_policy_info',
          'NAME' => static::getMessage('FIELD_RETURN_POLICY_INFO_NAME'),
          'SORT' => 1450,
          'DESCRIPTION' => static::getMessage('FIELD_RETURN_POLICY_INFO_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'LAUNCH_DATE',
          'DISPLAY_CODE' => 'launch_date',
          'NAME' => static::getMessage('FIELD_LAUNCH_DATE_NAME'),
          'SORT' => 1460,
          'DESCRIPTION' => static::getMessage('FIELD_LAUNCH_DATE_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'VISIBILITY',
          'DISPLAY_CODE' => 'visibility',
          'NAME' => static::getMessage('FIELD_VISIBILITY_NAME'),
          'SORT' => 1470,
          'DESCRIPTION' => static::getMessage('FIELD_VISIBILITY_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'OFFER_PRICE',
          'DISPLAY_CODE' => 'offer_price',
          'NAME' => static::getMessage('FIELD_OFFER_PRICE_NAME'),
          'SORT' => 1480,
          'DESCRIPTION' => static::getMessage('FIELD_OFFER_PRICE_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'OFFER_PRICE_EFFECTIVE_DATE',
          'DISPLAY_CODE' => 'offer_price_effective_date',
          'NAME' => static::getMessage('FIELD_OFFER_PRICE_EFFECTIVE_DATE_NAME'),
          'SORT' => 1490,
          'DESCRIPTION' => static::getMessage('FIELD_OFFER_PRICE_EFFECTIVE_DATE_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      $arResult[] = new Field(array(
          'CODE' => 'ADDITIONAL_VARIANT_ATTRIBUTE',
          'DISPLAY_CODE' => 'additional_variant_attribute',
          'NAME' => static::getMessage('FIELD_ADDITIONAL_VARIANT_ATTRIBUTE_NAME'),
          'SORT' => 1500,
          'DESCRIPTION' => static::getMessage('FIELD_ADDITIONAL_VARIANT_ATTRIBUTE_DESC'),
          'REQUIRED' => false,
          'MULTIPLE' => false,
          'DEFAULT_VALUE' => array(
              array(
      ...
      #
      unset($arAvailableFields, $strQuantityField, $strQuantityLogic, $arQuantityField, $arQuantityLogic, $arFilterJsonAvailable, $strFilterJsonAvailable, $arAdditionalFields);
      return $arResult;
   }
   ...
   public function processElement($arProfile, $intIBlockID, $arElement, $arFields) {
      ...
      if (!Helper::isEmpty($arFields['LINK']))
         $arXmlTags['g:link'] = $this->getXmlTag_Url($intProfileID, $arFields['LINK'], $strSiteURL, $arFields, true);
      if (!Helper::isEmpty($arFields['IMAGE_LINK']))
         $arXmlTags['g:image_link'] = $this->getXmlTag_Picture($intProfileID, $arFields['IMAGE_LINK'], $strSiteURL);
      if (!Helper::isEmpty($arFields['ADDITIONAL_IMAGE_LINK']))
         $arXmlTags['g:additional_image_link'] = $this->getXmlTag_Picture($intProfileID, $arFields['ADDITIONAL_IMAGE_LINK'], $strSiteURL);
      if (!Helper::isEmpty($arFields['MOBILE_LINK']))
         $arXmlTags['g:mobile_link'] = $this->getXmlTag_Url($intProfileID, $arFields['MOBILE_LINK'], $strSiteURL, $arFields, false);
      #
      ...
      if (!Helper::isEmpty($arFields['INVENTORY']))
         $arXmlTags['g:inventory'] = Xml::addTag($arFields['INVENTORY']);
      if (!Helper::isEmpty($arFields['SHIPPING_PROFILE_ID']))
         $arXmlTags['g:shipping_profile_id'] = Xml::addTag($arFields['SHIPPING_PROFILE_ID']);
      if (!Helper::isEmpty($arFields['RICH_TEXT_DESCRIPTION']))
         $arXmlTags['g:rich_text_description'] = Xml::addTag($arFields['RICH_TEXT_DESCRIPTION']);
      if (!Helper::isEmpty($arFields['RETURN_POLICY_INFO']))
         $arXmlTags['g:return_policy_info'] = Xml::addTag($arFields['RETURN_POLICY_INFO']);
      if (!Helper::isEmpty($arFields['LAUNCH_DATE']))
         $arXmlTags['g:launch_date'] = Xml::addTag($arFields['LAUNCH_DATE']);
      if (!Helper::isEmpty($arFields['VISIBILITY']))
         $arXmlTags['g:visibility'] = Xml::addTag($arFields['VISIBILITY']);
      if (!Helper::isEmpty($arFields['OFFER_PRICE']))
         $arXmlTags['g:offer_price'] = Xml::addTag($arFields['OFFER_PRICE']);
      if (!Helper::isEmpty($arFields['OFFER_PRICE_EFFECTIVE_DATE']))
         $arXmlTags['g:offer_price_effective_date'] = Xml::addTag($arFields['OFFER_PRICE_EFFECTIVE_DATE']);
      if (!Helper::isEmpty($arFields['ADDITIONAL_VARIANT_ATTRIBUTE']))
         $arXmlTags['g:additional_variant_attribute'] = Xml::addTag($arFields['ADDITIONAL_VARIANT_ATTRIBUTE']);
      # build XML
      $arXml = array(
          'item' => array(
              '#' => $arXmlTags,
      ...
      # event handlers OnFacebookTradeXml
      foreach (EventManager::getInstance()->findEventHandlers($this->strModuleId, 'OnFacebookTradeXml') as $arHandler) {
      ...
      $arResult = array(
          ...
          'CURRENCY' => $arFields['_CURRENCY'], # 'RUB' OR 'RUB,USD'
          'SECTION_ID' => reset($arElementSections),
          'ADDITIONAL_SECTIONS_ID' => array_slice($arElementSections, 1),
          'DATA_MORE' => array(),
      );
      # event handlers OnFacebookTradeResult
      foreach (EventManager::getInstance()->findEventHandlers($this->strModuleId, 'OnFacebookTradeResult') as $arHandler) {
    ...
    * 	Get XML tag: <url>
    */
   protected function getXmlTag_Url($intProfileID, $mValue, $strSiteURL, $arFields, $bAddUtm = true) {
      $strUrl = '';
      if (strlen($mValue)) {
         $strUrl = $mValue;
         if ($bAddUtm) {
   ...
   /**
    * 	Get XML tag: <g:picture>
    */
   protected function getXmlTag_Picture($intProfileID, $mValue, $strSiteURL) {
      $mResult = '';
      $mValue = is_array($mValue) ? $mValue : array($mValue);
      if (!empty($mValue)) {
         /* /
           $mValue = Helper::execAction($mValue, function($strFileSrc, $arParams)
           {
           return strlen($strFileSrc) ? $arParams['SITE_URL'] . $strFileSrc : '';
           }, array('SITE_URL' => $strSiteURL));/* */
         $mResult = array();
    ...
    */
   /*
     protected function getElement_SectionID($intProfileID, $arElement)
     {
     $intSectionID = 0;
     if ($arElement['IBLOCK_SECTION_ID'])
     {
