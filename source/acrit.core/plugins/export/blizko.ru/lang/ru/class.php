...
$MESS[$strMessPrefix . 'SETTINGS_ZIP_HINT'] = 'Данный параметр позволяет запаковать сформированный файл в Zip. Благодаря упаковке в Zip-архив, размер файла, отдаваемого в blizko.ru, существенно уменьшается, что ускоряет его скачивание сервисом.';
...
$MESS[$strMessPrefix . 'ENABLE_AUTO_DISCOUNTS_HINT'] = 'Опция позволяет для всего файла включить авторасчет скидок.<br/><br/><a href="https://yandex.ru/support/partnermarket/elements/enable_auto_discounts.html" target="_blank">Подробнее</a>';
...
$MESS[$strMessPrefix . 'HEADER_N_PLUS_M'] = 'При покупке N товаров M таких же товаров бесплатно';
$MESS[$strMessPrefix . 'HEADER_GIFTS'] = 'Выгрузка подарков';
...
$MESS[$strMessPrefix . 'FIELD_STEP_QUANTITY_DESC'] = 'Количество товара, которое покупатель может добавлять к минимальному в корзине blizko.ruа. Элемент используется в дополнение к min-quantity и только в категориях «Автошины» , «Грузовые шины», «Мотошины», «Диски».<br/><br/>Если элемент не указан, используется значение по умолчанию — 1.<br/><br/><a href="https://yandex.ru/support/partnermarket/elements/moq.html" target="_blank">Подробное описание элемента</a>.';
...
$MESS[$strMessPrefix . 'FIELD_N_PLUS_M_NAME'] = 'Выгружать N + M';
$MESS[$strMessPrefix . 'FIELD_N_PLUS_M_DESC'] = 'При покупке N товаров M таких же товаров бесплатно<br/>Указывайте в прайс-листе, сколько товаров нужно купить и сколько покупатель получит в подарок. <br/> Значение должно быть равно "Y"';
