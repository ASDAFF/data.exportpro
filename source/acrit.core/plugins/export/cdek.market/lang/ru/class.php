<?
$strMessPrefix = 'ACRIT_EXP_CDEK_MARKET_';

// General
$MESS[$strMessPrefix.'NAME'] = 'Сдэк.Маркет';

// Tabs
$MESS[$strMessPrefix.'TAB_PROMOS_NAME'] = 'Акции';
	$MESS[$strMessPrefix.'TAB_PROMOS_DESC'] = 'Акции Сдэк.Маркет (&lt;promos&gt;)';

// Default settings
$MESS[$strMessPrefix.'SETTINGS_FILE'] = 'Итоговый файл';
	$MESS[$strMessPrefix.'SETTINGS_FILE_PLACEHOLDER'] = 'Например, /upload/xml/cdek_market.xml';
...
$MESS[$strMessPrefix.'SETTINGS_DELETE_XML_IF_ZIP'] = 'Удалить XML-файл';
	...
	$MESS[$strMessPrefix.'CDEK_LANGUAGES'] = 'Язык ленты';
$MESS[$strMessPrefix.'CDEK_LANGUAGES_HINT'] = 'Язык ленты RSS согласно стандарту ISO 639-1';



// Fields
$MESS[$strMessPrefix.'FIELD_ID_NAME'] = 'Идентификатор товара';
$MESS[$strMessPrefix.'FIELD_ID_DESC'] = 'Идентификатор товара. Может состоять только из цифр и латинских букв.';

$MESS[$strMessPrefix.'FIELD_PRODUCT_CODE_NAME'] = 'Артикул товара';
$MESS[$strMessPrefix.'FIELD_PRODUCT_CODE_DESC'] = 'Артикул товара. Обязательное поле.';

$MESS[$strMessPrefix.'FIELD_LANGUAGE_NAME'] = 'Язык сайта';
$MESS[$strMessPrefix.'FIELD_LANGUAGE_DESC'] = 'Язык сайта';

$MESS[$strMessPrefix.'FIELD_LIST_PRICE_NAME'] = 'Рекомендованная цена';
$MESS[$strMessPrefix.'FIELD_LIST_PRICE_DESC'] = 'Рекомендованная цена';

$MESS[$strMessPrefix.'FIELD_PRICE_NAME'] = 'Цена';
$MESS[$strMessPrefix.'FIELD_PRICE_DESC'] = 'Цена';

$MESS[$strMessPrefix.'FIELD_QUANTITY_NAME'] = 'Доступное количество';
$MESS[$strMessPrefix.'FIELD_QUANTITY_DESC'] = 'Доступное количество';

$MESS[$strMessPrefix.'FIELD_WEIGHT_NAME'] = 'Вес товара';
$MESS[$strMessPrefix.'FIELD_WEIGHT_DESC'] = 'Вес товара';

$MESS[$strMessPrefix.'FIELD_MIN_QUANTITY_NAME'] = 'Минимальное количество';
$MESS[$strMessPrefix.'FIELD_MIN_QUANTITY_DESC'] = 'Минимальное количество, доступное для заказа';

$MESS[$strMessPrefix.'FIELD_MAX_QUANTITY_NAME'] = 'Максимальное количество';
$MESS[$strMessPrefix.'FIELD_MAX_QUANTITY_DESC'] = 'Максимальное количество, доступное для заказа';

$MESS[$strMessPrefix.'FIELD_SHIPPING_FREIGHRT_NAME'] = 'Стоимость доставки';
$MESS[$strMessPrefix.'FIELD_SHIPPING_FREIGHRT_DESC'] = 'Стоимость доставки';

$MESS[$strMessPrefix.'FIELD_DATE_ADDED_NAME'] = 'Стоимость доставки';
$MESS[$strMessPrefix.'FIELD_DATE_ADDED_DESC'] = 'Стоимость доставки';

$MESS[$strMessPrefix.'FIELD_DATE_ADDED_NAME'] = 'Дата добавления';
$MESS[$strMessPrefix.'FIELD_DATE_ADDED_DESC'] = 'Дата добавления';

$MESS[$strMessPrefix.'FIELD_DOWNLOADABLE_NAME'] = 'Цифровой товар';
$MESS[$strMessPrefix.'FIELD_DOWNLOADABLE_DESC'] = 'Цифровой товар, доступный для скачивания';

$MESS[$strMessPrefix.'FIELD_FILES_NAME'] = 'Файлы';
$MESS[$strMessPrefix.'FIELD_FILES_DESC'] = 'Дополнительные файлы, доступные для скачивания';

$MESS[$strMessPrefix.'FIELD_THUMBNAIL_NAME'] = 'Иконка';
$MESS[$strMessPrefix.'FIELD_THUMBNAIL_DESC'] = 'Иконка';

$MESS[$strMessPrefix.'FIELD_DETAILED_IMAGE_NAME'] = 'Детальная картинка';
$MESS[$strMessPrefix.'FIELD_DETAILED_IMAGE_DESC'] = 'Детальная картинка';

$MESS[$strMessPrefix.'FIELD_PRODUCT_NAME_NAME'] = 'Название товара';
$MESS[$strMessPrefix.'FIELD_PRODUCT_NAME_DESC'] = 'Название товара';

$MESS[$strMessPrefix.'FIELD_DESCRIPTION_NAME'] = 'Описание товара';
$MESS[$strMessPrefix.'FIELD_DESCRIPTION_DESC'] = 'Описание товара';

$MESS[$strMessPrefix.'FIELD_SHORT_DESCRIPTION_NAME'] = 'Короткое описание';
$MESS[$strMessPrefix.'FIELD_SHORT_DESCRIPTION_DESC'] = 'Короткое описание товара';

$MESS[$strMessPrefix.'FIELD_META_KEYWORDS_NAME'] = 'Мета-ключевые слова';
$MESS[$strMessPrefix.'FIELD_META_KEYWORDS_DESC'] = 'Мета-ключевые слова';

$MESS[$strMessPrefix.'FIELD_META_DESCRIPTION_NAME'] = 'Мета описание';
$MESS[$strMessPrefix.'FIELD_META_DESCRIPTION_DESC'] = 'Мета описание';

$MESS[$strMessPrefix.'FIELD_SEARCH_WORDS_NAME'] = 'Ключевые слова для поиска';
$MESS[$strMessPrefix.'FIELD_SEARCH_WORDS_DESC'] = 'Ключевые слова для поиска';

$MESS[$strMessPrefix.'FIELD_PAGE_TITLE_NAME'] = 'Название страницы';
$MESS[$strMessPrefix.'FIELD_PAGE_TITLE_DESC'] = 'Название страницы';

$MESS[$strMessPrefix.'FIELD_PROMO_TEXT_NAME'] = 'Промо текст';
$MESS[$strMessPrefix.'FIELD_PROMO_TEXT_DESC'] = 'Промо текст';

$MESS[$strMessPrefix.'FIELD_TAXES_NAME'] = 'Налоги';
$MESS[$strMessPrefix.'FIELD_TAXES_DESC'] = 'Налоги';

$MESS[$strMessPrefix.'FIELD_FEATURES_NAME'] = 'Характеристики';
$MESS[$strMessPrefix.'FIELD_FEATURES_DESC'] = 'Характеристики';

$MESS[$strMessPrefix.'FIELD_OPTIONS_NAME'] = 'Опции';
$MESS[$strMessPrefix.'FIELD_OPTIONS_DESC'] = 'Опции';

$MESS[$strMessPrefix.'FIELD_ITEMS_IN_BOX_NAME'] = 'Штук в коробке';
$MESS[$strMessPrefix.'FIELD_ITEMS_IN_BOX_DESC'] = 'Количество штук в коробке';

$MESS[$strMessPrefix.'FIELD_BOX_SIZE_NAME'] = 'Размер коробки';
$MESS[$strMessPrefix.'FIELD_BOX_SIZE_DESC'] = 'Размер коробки';

$MESS[$strMessPrefix.'FIELD_USERGROUP_ID_NAME'] = 'ID групп';
$MESS[$strMessPrefix.'FIELD_USERGROUP_ID_DESC'] = 'ID групп пользователей';

$MESS[$strMessPrefix.'FIELD_VENDOR_NAME'] = 'Продавец';
$MESS[$strMessPrefix.'FIELD_VENDOR_DESC'] = 'Продавец';
...
$MESS[$strMessPrefix.'DELIVERY'] = 'Общие условия доставки';
	...
	$MESS[$strMessPrefix.'DELIVERY_HINT'] = 'Укажите здесь общие условия доставки. <a href="https://yandex.ru/support/partnermarket/elements/delivery-options.html" target="_blank">Подробная информация</a>.';
$MESS[$strMessPrefix.'ENABLE_AUTO_DISCOUNTS'] = 'Авторасчет скидок';
	$MESS[$strMessPrefix.'ENABLE_AUTO_DISCOUNTS_HINT'] = 'Опция позволяет для всего файла включить авторасчет скидок.<br/><br/>
<p><b>Механизм работы</b></p>
<p>Если вы включили показ скидок, Маркет:</p>
<ol>
	<li>Анализирует, как менялась ваша цена на товар в последнее время.</li>
	<li>Проверяет, была ли цена, для которой выполняются все условия. Если цена не нашлась, предложение показывается без скидки.</li>
	<li>Вычисляет скидку от этой цены.</li>
	<li>Показывает рассчитанную старую цену и скидку.</li>
</ol>
<p><b>Внимание! Данный функционал никак не изменяет ни цены, ни скидки в файле выгрузки.</b></p>
<br/><br/><a href="https://yandex.ru/support/partnermarket/elements/enable_auto_discounts.html" target="_blank">Подробнее</a>';
...
$MESS[$strMessPrefix.'HEADER_PROMOS_SPECIAL_PRICE'] = 'ПРОМО: Специальная цена';
$MESS[$strMessPrefix.'HEADER_PROMOS_N_PLUS_M'] = 'ПРОМО: Акция N+M';
$MESS[$strMessPrefix.'HEADER_PROMOS_GIFTS'] = 'ПРОМО: Подарки';
...
$MESS[$strMessPrefix.'FIELD_ENABLE_AUTO_DISCOUNTS_NAME'] = 'Автоматический расчет скидок';
	$MESS[$strMessPrefix.'FIELD_ENABLE_AUTO_DISCOUNTS_DESC'] = 'Данное поле позволяет включить или отключить автоматический расчет и показ скидок для отдельных товаров.<br/><br/>
Доступные значения:<br/>
<ul>
	<li>yes, true, 1 — показ скидок включен;</li>
	<li>no, false, 0 — показ скидок выключен.</li>
</ul>
<p><b>Совет</b>. Чтобы включить показ скидок сразу для всех предложений в прайс-листе, укажите элемент enable_auto_discounts в настройках выгрузки. Для отдельных товаров показ можно отключить с помощью данного поля.</p>
