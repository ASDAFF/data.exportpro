...
$MESS[$strMessPrefix . 'TAB_ATTR_NAME'] = 'Поля разделов Ozon';
$MESS[$strMessPrefix . 'TAB_ATTR_DESC'] = 'Дополнительные поля';
...
$MESS[$strMessPrefix . 'LOAD_ATTR'] = 'Загрузить/обновить свойства разделов Ozon ';
...
$MESS[$strMessPrefix . 'LOADED_CATEGORIES'] = 'Обработано разделов ';
$MESS[$strMessPrefix . 'LOADING'] = 'Загрузка ... ';
$MESS[$strMessPrefix . 'CATEGORY'] = 'Раздел ';
$MESS[$strMessPrefix . 'ATTRIBUTE'] = 'Атрибут';
$MESS[$strMessPrefix . 'LOAD_FINISHED'] = 'Загрузка завершена.';
$MESS[$strMessPrefix . 'LOAD_TIME'] = 'Затрачено времени';
$MESS[$strMessPrefix . 'LOAD_MIN'] = ' мин';
$MESS[$strMessPrefix . 'BIG_VALUES_FILE'] = 'Колличество вариантов очень большое, посмотреть их открыв тектовым редактором (например Notepad++) файл /upload/ozon_attributes/attributes_dict_';
?>