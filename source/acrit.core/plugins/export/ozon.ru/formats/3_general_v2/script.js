...
$(document).ready(function () {
   ...
   $(document).delegate('.run_load_attributes', 'click',
           function (e) {
              console.log('run_load_attributes');
              loadAttr();
           });
   ...
   function loadAttr() {
      ...
      acritExpAjax(['plugin_ajax_action', 'load_attr'], data,
              function (JsonResult, textStatus, jqXHR) {
                 $('.res_load_attributes').html(JsonResult.Text);
                 if (JsonResult.Status == 'next') {
                    loadAttr();
                 }
                 console.log(JsonResult);
              }, function (jqXHR) {
