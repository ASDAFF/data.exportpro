 ...
 * @documentation http://autoload.avito.ru/format/zhivotnye
 */
...
class AvitoAnimals extends Avito {
   ...
   public static function getCode() {
      return parent::getCode() . '_ANIMALS';
   }
   ...
   public function getFields($intProfileID, $intIBlockID, $bAdmin = false) {
      ...
      $arResult[] = new Field(array(
          'CODE' => 'BREED',
          'DISPLAY_CODE' => 'Breed',
          'NAME' => static::getMessage('FIELD_BREED_NAME'),
          'SORT' => 1010,
          'DESCRIPTION' => static::getMessage('FIELD_BREED_DESC'),
          'REQUIRED' => true,
      ));
      #
   ...
   public function processElement($arProfile, $intIBlockID, $arElement, $arFields) {
      ...
      if (!Helper::isEmpty($arFields['BREED']))
         $arXmlTags['Breed'] = Xml::addTag($arFields['BREED']);
      # build XML
      $arXml = array(
          'Ad' => array(
              '#' => $arXmlTags,
