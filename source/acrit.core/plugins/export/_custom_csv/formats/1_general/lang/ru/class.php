...
// General
$MESS[$strMessPrefix.'NAME'] = '[Произвольный CSV]';
...
$MESS[$strMessPrefix.'SETTINGS_FILE'] = 'Итоговый файл';
	$MESS[$strMessPrefix.'SETTINGS_FILE_PLACEHOLDER'] = 'Например, /upload/csv/custom.csv';
	$MESS[$strMessPrefix.'SETTINGS_FILE_HINT'] = 'Укажите здесь файл, в который будет выполняться экспорт по данному профилю.<br/><br/><b>Пример указания файла</b>:<br/><code>/upload/csv/custom.csv</code>';
...
$MESS[$strMessPrefix.'SETTINGS_DELETE_CSV_IF_ZIP'] = 'Удалить CSV-файл';
	$MESS[$strMessPrefix.'SETTINGS_DELETE_CSV_IF_ZIP_HINT'] = 'Данная опция позволяет удалить сгенерированный CSV-файл, оставив только ZIP-архив.';

// Tabs
$MESS[$strMessPrefix.'TAB_CSV_SETTINGS_NAME'] = 'Настройки CSV';
	$MESS[$strMessPrefix.'TAB_CSV_SETTINGS_TITLE'] = 'Общие настройки CSV';
...
#
$MESS[$strMessPrefix.'INVALID_CSV_GENERAL'] = 'Указан некорректный CSV для выгрузки.';
$MESS[$strMessPrefix.'INVALID_CSV_CATEGORY'] = 'Указан некорректный CSV для категории.';
$MESS[$strMessPrefix.'INVALID_CSV_CURRENCY'] = 'Указан некорректный CSV для валюты.';
$MESS[$strMessPrefix.'INVALID_CSV_ITEM'] = 'Указан некорректный CSV для товара (инфоблок #IBLOCK_ID#).';
$MESS[$strMessPrefix.'INVALID_CSV_OFFER'] = 'Указан некорректный CSV для предложения (инфоблок #IBLOCK_ID#).';

# Steps
$MESS[$strMessPrefix.'STEP_EXPORT'] = 'Запись в CSV-файл';
