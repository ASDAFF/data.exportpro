...
$MESS[$strMessPrefix.'TAB_PROMOS_NAME'] = 'Акции';
	$MESS[$strMessPrefix.'TAB_PROMOS_DESC'] = 'Акции Яндекс.Маркет (&lt;promos&gt;)';

// Subtabs
$MESS[$strMessPrefix.'SUBTAB_XML_PRICELABS_NAME'] = 'PriceLabs';
	$MESS[$strMessPrefix.'SUBTAB_XML_PRICELABS_TITLE'] = 'Дополнительные настройки для PriceLabs';
...
$MESS[$strMessPrefix.'HEADER_PROMOS_PROMOCARD'] = 'ПРОМО: Скидка по программе лояльности';
$MESS[$strMessPrefix.'HEADER_PROMOS_N_PLUS_M'] = 'ПРОМО: Акция N+M';
$MESS[$strMessPrefix.'HEADER_PROMOS_GIFTS'] = 'ПРОМО: Подарки';
$MESS[$strMessPrefix.'HEADER_PRICELABS_PARAMS'] = 'Пользовательские параметры PriceLabs (&lt;pricelabs_param&gt;)';
...
$MESS[$strMessPrefix.'FIELD_CATEGORY_NAME_CUSTOM_NAME'] = 'Название категории';
	$MESS[$strMessPrefix.'FIELD_CATEGORY_NAME_CUSTOM_DESC'] = 'Укажите здесь собственное название категории (работает только если опция «Источник названий категорий» имеет значение «Использовать свойства элементов»).';
...
#
$MESS[$strMessPrefix.'FIELD_PROMOCARD_START_NAME'] = 'Дата и время начала акции';
	$MESS[$strMessPrefix.'FIELD_PROMOCARD_START_DESC'] = 'Примеры:<ul>2018-09-01</li><li>2018-09-01 09:00</li><li>2018-09-01 09:00:01</li><li>2018-09-01 09:00+0500</li><li>2018-09-01 09:00:01+0500</li></ul><br/><br/>
	Минимальная длительность действия цены — 2 дня: данные об акциях обновляются на Маркете каждые 4 часа, и цена, действительная на короткий срок, может не успеть отобразиться.';
$MESS[$strMessPrefix.'FIELD_PROMOCARD_END_NAME'] = 'Дата и время завершения акции';
	$MESS[$strMessPrefix.'FIELD_PROMOCARD_END_DESC'] = 'Примеры:<ul>2018-09-01</li><li>2018-09-01 09:00</li><li>2018-09-01 09:00:01</li><li>2018-09-01 09:00+0500</li><li>2018-09-01 09:00:01+0500</li></ul><br/><br/>
	Минимальная длительность действия цены — 2 дня: данные об акциях обновляются на Маркете каждые 4 часа, и цена, действительная на короткий срок, может не успеть отобразиться.';
$MESS[$strMessPrefix.'FIELD_PROMOCARD_DESCRIPTION_NAME'] = 'Краткое описание акции';
	$MESS[$strMessPrefix.'FIELD_PROMOCARD_DESCRIPTION_DESC'] = 'Краткое описание акции. Максимум 500 символов. Можно использовать xhtml-разметку, но только в виде блока символьных данных CDATA.';
	$MESS[$strMessPrefix.'FIELD_PROMOCARD_DESCRIPTION_DEF'] = 'Специальная цена на #PRODUCT_NAME#';
$MESS[$strMessPrefix.'FIELD_PROMOCARD_URL_NAME'] = 'Ссылка на описание акции на сайте магазина';
	$MESS[$strMessPrefix.'FIELD_PROMOCARD_URL_DESC'] = 'Ссылка на описание акции на сайте магазина.';
$MESS[$strMessPrefix.'FIELD_PROMOCARD_PRICE_NAME'] = 'Цена по программе лояльности';
	$MESS[$strMessPrefix.'FIELD_PROMOCARD_PRICE_DESC'] = '';
$MESS[$strMessPrefix.'FIELD_PROMOCARD_CURRENCY_NAME'] = 'Валюта';
	$MESS[$strMessPrefix.'FIELD_PROMOCARD_CURRENCY_DESC'] = '';
#
...
$MESS[$strMessPrefix.'FIELD_PRICELABS_PARAM_DESC'] = 'Значение параметра может быть только числовым.';
