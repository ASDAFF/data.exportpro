...
$MESS[$strMessPrefix.'SEPARATOR_TAB'] = 'табуляция';
...
$MESS[$strMessPrefix.'SETTINGS_FILE'] = 'Итоговый файл';
	$MESS[$strMessPrefix.'SETTINGS_FILE_PLACEHOLDER'] = 'Например, /upload/excel/custom.excel';
	$MESS[$strMessPrefix.'SETTINGS_FILE_HINT'] = 'Укажите здесь файл, в который будет выполняться экспорт по данному профилю.<br/><br/><b>Пример указания файла</b>:<br/><code>/upload/excel/custom.xls</code>';
$MESS[$strMessPrefix.'SETTINGS_FORMAT'] = 'Формат файла';
	$MESS[$strMessPrefix.'SETTINGS_FORMAT_HINT'] = 'Выберите требуемый формат файла Excel: xlsx (новый) или xls (старый).<br/><br/><b>Внимание!</b> При изменении формата автоматически меняется расширение файла в поле «Итоговый файл», будьте внимательны!';
...
$MESS[$strMessPrefix.'SETTINGS_DELETE_EXCEL_IF_ZIP'] = 'Удалить Excel-файл';
	$MESS[$strMessPrefix.'SETTINGS_DELETE_EXCEL_IF_ZIP_HINT'] = 'Данная опция позволяет удалить сгенерированный Excel-файл, оставив только ZIP-архив.';

// Formats
$MESS[$strMessPrefix.'FORMAT_XLSX'] = 'xlsx (новый формат MS Excel)';
$MESS[$strMessPrefix.'FORMAT_XLS'] = 'xls (старый формат MS Excel)';
$MESS[$strMessPrefix.'FORMAT_ODS'] = 'ods (формат OpenOffice)';

// Tabs
$MESS[$strMessPrefix.'TAB_EXCEL_SETTINGS_NAME'] = 'Настройки Excel';
	$MESS[$strMessPrefix.'TAB_EXCEL_SETTINGS_TITLE'] = 'Общие настройки Excel';

//
$MESS[$strMessPrefix.'DEFAULT_SHEET_TITLE'] = 'Экспорт товаров';
...
#
$MESS[$strMessPrefix.'INVALID_EXCEL_GENERAL'] = 'Указан некорректный Excel для выгрузки.';
$MESS[$strMessPrefix.'INVALID_EXCEL_CATEGORY'] = 'Указан некорректный Excel для категории.';
$MESS[$strMessPrefix.'INVALID_EXCEL_CURRENCY'] = 'Указан некорректный Excel для валюты.';
$MESS[$strMessPrefix.'INVALID_EXCEL_ITEM'] = 'Указан некорректный Excel для товара (инфоблок #IBLOCK_ID#).';
$MESS[$strMessPrefix.'INVALID_EXCEL_OFFER'] = 'Указан некорректный Excel для предложения (инфоблок #IBLOCK_ID#).';

# Steps
$MESS[$strMessPrefix.'STEP_EXPORT'] = 'Запись в Excel-файл';
...
$MESS[$strMessPrefix.'LARGE_FILE_NOTICE'] = '<b>Внимание!</b> Во избежание проблем, связанных с выгрузкой больших файлов в Excel, рекомендуем делать выгрузку в несколько небольших файлов.';
