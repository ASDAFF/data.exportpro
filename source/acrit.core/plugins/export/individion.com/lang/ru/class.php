...
$strMessPrefix = 'ACRIT_EXP_INDIVIDION_COM_';

// General
$MESS[$strMessPrefix . 'NAME'] = 'individion.com';

// Tabs
$MESS[$strMessPrefix . 'TAB_PROMOS_NAME'] = 'Акции';
$MESS[$strMessPrefix . 'TAB_PROMOS_DESC'] = 'Акции individion.com (&lt;promos&gt;)';

// Default settings
$MESS[$strMessPrefix . 'SETTINGS_FILE'] = 'Итоговый файл';
$MESS[$strMessPrefix . 'SETTINGS_FILE_PLACEHOLDER'] = 'Например, /upload/xml/individion_com.xml';
