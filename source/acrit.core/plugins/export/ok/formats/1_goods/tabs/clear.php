...
$strOkGroupId = strval($arProfile['PARAMS']['GROUP_ID']);
$strOkOwnerId = intval('-' . $strOkGroupId);
$arAlbums = $obPlugin::getGroupAlbums($strOkOwnerId, $intProfileID);
...
?>
    <tr id="row_OK_GOODS_CLEAR_LOADED">
        <td width="40%" valign="top">
...
?>
    <tr id="row_OK_GOODS_CLEAR_ALBUM">
        <td width="40%" valign="top">
