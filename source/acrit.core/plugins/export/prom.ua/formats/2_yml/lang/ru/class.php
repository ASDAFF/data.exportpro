...
// General
$MESS[$strLang.'NAME'] = 'Prom.ua (формат YML)';
...
Тип vendor.model используется для «склейки» названия импортируемой позиции на Prom.ua по принципу «typePrefix + vendor + model».<br/><br/>
При указании vendor.model должен быть обязательно установлен параметр «Название_модели».';
	$MESS[$strName.'@selling_type'] = 'Тип товара на Prom.ua';
