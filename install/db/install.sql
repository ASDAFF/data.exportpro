CREATE TABLE IF NOT EXISTS `data_exportpro_profile`(
...
CREATE TABLE IF NOT EXISTS `data_exportpro_profile_data`(
    `ID` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `data_exportpro_profile_tools`(
    `ID` int(11) NOT NULL auto_increment,
    `PROFILE_ID` int(11) NOT NULL,
