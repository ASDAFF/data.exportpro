...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[USE_VARIANT]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_USE_VARIANT_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_USE_VARIANT" )?>
    </td>
    <td width="50%">
...
<tr align="center" class="heading">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SETTINGS" )?></td>
</tr>
<tr align="center">
    <td colspan="2">
        <?echo BeginNote();
        echo GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SEX_DESCRIPTION" );
        echo EndNote();?>
    </td>
</tr>
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][SEX]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SEX_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SEX" )?>
    </td>
    <td width="50%">
...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace(BX('hint_PROFILE[VARIANT][SEXOFFER]'), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SEX_OFFER_HELP" )?>');</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SEX_OFFER" )?>
    </td>
    <td width="50%">
...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][SEX_CONST]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SEX_CONST_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SEX_CONST" )?>
    </td>
    <td width="50%">
...
<tr align="center">
    <td colspan="2" style="width: 200%; height: 205px; display: inline-block;">
        <?echo BeginNote();
        echo GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_COLOR_DESCRIPTION" );
        echo EndNote();?>
    </td>
</tr>
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][COLOR]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_COLOR_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_COLOR" )?>
    </td>
    <td width="50%">
...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][COLOROFFER]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_COLOR_OFFER_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_COLOR_OFFER" )?>
    </td>
    <td width="50%">
...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][SIZE]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SIZE_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SIZE" )?>
    </td>
    <td width="50%">
...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][SIZEOFFER]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SIZE_OFFER_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_SIZE_OFFER" )?>
    </td>
    <td width="50%">
...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][WEIGHT]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_WEIGHT_HELP" )?>');</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_WEIGHT" )?>
    </td>
    <td width="50%">
...
<tr>
    <td width="50%">
        ...
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][WEIGHTOFFER]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_WEIGHT_OFFER_HELP" )?>');</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_WEIGHT_OFFER" )?>
    </td>
    <td width="50%">
...
<tr align="center" class="heading">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_PRICE_TITLE" )?></td>
</tr>
<tr>
    <td width="50%">
        <span id="hint_PROFILE[VARIANT][PRICE]"></span>
        <script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VARIANT][PRICE]' ), '<?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_PRICE_HELP" )?>' );</script>
        <?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_PRICE" )?>
    </td>
    <td width="50%">
...
<tr align="center" class="heading">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_VARIANT_LIST_CATEGORY" )?></td>
</tr>
