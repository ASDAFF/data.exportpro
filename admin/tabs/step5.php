...
$roundModes = array(
    "none" => GetMessage( "DATA_EXPORTPRO_NE_VYBRANO" ),
    "UP" => GetMessage( "DATA_EXPORTPRO_FIELDSET_ROUND_MODE_UP" ),
    "DOWN" => GetMessage( "DATA_EXPORTPRO_FIELDSET_ROUND_MODE_DOWN" ),
    "EVEN" => GetMessage( "DATA_EXPORTPRO_FIELDSET_ROUND_MODE_EVEN" ),
    "ODD" => GetMessage( "DATA_EXPORTPRO_FIELDSET_ROUND_MODE_ODD" )
);
$idCnt = 0;                      
?>
<tr class="heading" align="center">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_FIELDSET_HEADER" )?></td>
</tr>
<tr align="center">
    <td colspan="2">
        <?=BeginNote();?>
        <?=GetMessage( "DATA_EXPORTPRO_FIELDSET_DESCRIPTION" )?>
        <?=EndNote();?>
    </td>
</tr>
<tr>
                    ...
                    <tr class="fieldset-item" data-id="<?=$idCnt++?>">
                        ...
                        <td colspan="2" style="position: relative" class="adm-detail-content-cell-r">
                            ...
                            <div class="const-block <?=$hideConstBlock?>">
                                ...
                                <textarea name="PROFILE[XMLDATA][<?=$id?>][CONTVALUE_TRUE]" <?=$showPlaceholder?>="<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONDITION_TRUE" )?>"><?=$field["CONTVALUE_TRUE"]?></textarea>
                                ...
                                <div class="complex-block">
                                    ...
                                    <div>
                                        ...
                                        <div class="const-block-complex <?=$hideComplexConstTrueBlock?>">
                                            <textarea name="PROFILE[XMLDATA][<?=$id?>][COMPLEX_TRUE_CONTVALUE]" <?=$showPlaceholder?>="<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONDITION_TRUE" )?>"><?=$field["COMPLEX_TRUE_CONTVALUE"]?></textarea>
                                        </div>
                                    </div>                                                                 
                                    <div class="<?=$hideComplexFalse?>">                                                                 
                                        ...
                                        <div class="const-block-complex-false <?=$hideComplexConstFalseBlock?>">
                                            <textarea name="PROFILE[XMLDATA][<?=$id?>][COMPLEX_FALSE_CONTVALUE]" <?=$showPlaceholder?>="<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONDITION_TRUE" )?>"><?=$field["COMPLEX_FALSE_CONTVALUE"]?></textarea>
                                        </div>
                                    </div>                                                                 
                                </div>
                            </div>
                            ...
                            <div style="margin: 10px 0px 10px 15px;">
                                <span id="hint_EXPORTPRO_FIELDSET_REQUIRED"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_REQUIRED' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_REQUIRED_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_CONDITION"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_CONDITION' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONDITION_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_DELETE_ONEMPTY"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_DELETE_ONEMPTY' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_DELETE_ONEMPTY_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_URL_ENCODE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_URL_ENCODE' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_URL_ENCODE_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_CONVERT_CASE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_CONVERT_CASE' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONVERT_CASE_HELP" )?>' );</script>                    
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_HTML_ENCODE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_HTML_ENCODE' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_HTML_ENCODE_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_HTML_ENCODE_CUT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_HTML_ENCODE_CUT' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_HTML_ENCODE_CUT_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_HTML_TO_TXT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_HTML_TO_TXT' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_HTML_TO_TXT_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_SKIP_UNTERM_ELEMENT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_SKIP_UNTERM_ELEMENT' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_SKIP_UNTERM_ELEMENT_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_TEXT_LIMIT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_TEXT_LIMIT' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_TEXT_LIMIT_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_MULTIPROP_LIMIT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_MULTIPROP_LIMIT' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_MULTIPROP_LIMIT_HELP" )?>' );</script>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_ROUND_PRECISION"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_ROUND_PRECISION' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_ROUND_PRECISION_HELP" )?>' );</script>
                                <label for="PROFILE[XMLDATA][<?=$id?>][ROUND][PRECISION]"><?=GetMessage( "DATA_EXPORTPRO_FIELDSET_ROUND_PRECISION" )?></label><br/>
                                ...
                                <div class="minimum_offer_price" data-dependent="price" <?if( $selectedPropertyType == "price" ):?><?else:?>style="display: none"<?endif;?>>
                                    <div style="height: 5px;">&nbsp;</div>
                                    <span id="hint_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE_HELP" )?>' );</script>
                                    ...
                                    <label for="PROFILE[XMLDATA][<?=$id?>][MINIMUM_OFFER_PRICE]"><?=GetMessage( "DATA_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE" )?></label>
                                
                                    <div class="minimum_offer_price_code" <?if( strlen( $calculateMinimum ) ):?><?else:?>style="display: none"<?endif;?>>
                                        <div style="height: 5px;">&nbsp;</div>
                                        <span id="hint_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE_CODE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE_CODE' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE_CODE_HELP" )?>' );</script>
                                        <label for="PROFILE[XMLDATA][<?=$id?>][MINIMUM_OFFER_PRICE_CODE]"><?=GetMessage( "DATA_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE_CODE" )?></label>
                                        <div>
                                ...
                                <span id="hint_EXPORTPRO_FIELDSET_CONVERT_DATA"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPRO_FIELDSET_CONVERT_DATA' ), '<?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONVERT_DATA_HELP" )?>' );</script>
                                <label for="PROFILE[XMLDATA][<?=$id?>][CONVERT_DATA]"><?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONVERT_DATA" )?></label><br/>
                                ...
                                <div data-row-id="<?=$id?>" style="margin: 0 auto; padding: 10px; text-align: center;">
                                    <button class="adm-btn" onclick="FieldsetConvertFieldsetAdd( this ); return false;">
                                        <?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONVERT_CONDITION_ADD" )?>
                                    </button>
                                </div>
                            </div>
...
<tr>
    <td colspan="2" align="center" id="fieldset-item-add-button">
        <button class="adm-btn" onclick="FieldsetAdd( this ); return false;">
            <?=GetMessage( "DATA_EXPORTPRO_FIELDSET_CONDITION_ADD" );?>
        </button>
    </td>
</tr>