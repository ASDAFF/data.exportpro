...
<tr class="heading" align="center">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_CONVERT_FIELDSET_HEADER" )?></td>
</tr>
<tr align="center">
    <td colspan="2">
        <?=BeginNote();?>
        <?=GetMessage( "DATA_EXPORTPRO_CONVERT_FIELDSET_DESCRIPTION" )?>
        <?=EndNote();?>
    </td>
</tr>
<tr>
...
<tr>
    <td colspan="2" align="center" id="fieldset-item-add-button">
        <button class="adm-btn" onclick="ConvertFieldsetAdd( this ); return false;">
            <?=GetMessage( "DATA_EXPORTPRO_CONVERT_FIELDSET_CONDITION_ADD" )?>
        </button>
    </td>
</tr>