...
$time[] = GetMessage( "DATA_EXPORTPRO_NOSELECT" );
...
$time["d.m.Y_h:i:s"] = date( "d.m.Y h:i:s", time() );
$time["c"] = date( "c", time() );
$time["Y-m-d_h:i:s_".GetMessage( "DATA_EXPORTPRO_" )] = date( "Y-m-d h:m:s ".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["Y-m-d_h:i:s_".GetMessage( "DATA_EXPORTPRO_1" )] = date( "Y-m-d h:i:s ".GetMessage( "DATA_EXPORTPRO_1" ), time() );
$time["Y-m-d_h:i:s_".GetMessage( "DATA_EXPORTPRO_2" )] = date( "Y-m-d h:i:s ".GetMessage( "DATA_EXPORTPRO_2" ), time() );
$time["Y/m/d_h:i:s_".GetMessage( "DATA_EXPORTPRO_" )] = date( "Y/m/d h:i:s ".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["Y/m/d_h:i:s_".GetMessage( "DATA_EXPORTPRO_1" )] = date( "Y/m/d h:i:s ".GetMessage( "DATA_EXPORTPRO_1" ), time() );
$time["Y/m/d_h:i:s_".GetMessage( "DATA_EXPORTPRO_2" )] = date( "Y/m/d h:i:s ".GetMessage( "DATA_EXPORTPRO_2" ), time() );
$time["D/m/Y_h:i:s_".GetMessage( "DATA_EXPORTPRO_" )] = date( "D/m/Y h:i:s ".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["D/m/Y_h:i:s_".GetMessage( "DATA_EXPORTPRO_1" )] = date( "D/m/Y h:i:s ".GetMessage( "DATA_EXPORTPRO_1" ), time() );
$time["D/m/Y_h:i:s_".GetMessage( "DATA_EXPORTPRO_2" )] = date( "D/m/Y h:i:s ".GetMessage( "DATA_EXPORTPRO_2" ), time() );
$time["d.m.Y_h:i:s".GetMessage( "DATA_EXPORTPRO_" )] = date( "d.m.Y h:i:s".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["d.m.Y_h:i:s".GetMessage( "DATA_EXPORTPRO_1" )] = date( "d.m.Y h:i:s".GetMessage( "DATA_EXPORTPRO_1" ), time() );
$time["d.m.Y_h:i:s".GetMessage( "DATA_EXPORTPRO_2" )] = date( "d.m.Y h:i:s".GetMessage( "DATA_EXPORTPRO_2" ), time() );
$time["Ymd"] = date( "Ymd", time() );
$time["Y-m-d"] = date( "Y-m-d", time() );
$time["YmdThis".GetMessage( "DATA_EXPORTPRO_" )] = date( "YmdThis".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["YmdThis".GetMessage( "DATA_EXPORTPRO_1" )] = date( "YmdThis".GetMessage( "DATA_EXPORTPRO_1" ), time() );
$time["Y-m-dTh:i:s".GetMessage( "DATA_EXPORTPRO_" )] = date( "Y-m-dTh:i:s".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["Y-m-dTh:i:s".GetMessage( "DATA_EXPORTPRO_2" )] = date( "Y-m-dTh:i:s".GetMessage( "DATA_EXPORTPRO_2" ), time() );
$time["YmdThis"] = date( "YmdThis", time() );
$time["Y-m-dTh:i:s"] = date( "Y-m-dTh:i:s", time() );
$time["YmdThi".GetMessage( "DATA_EXPORTPRO_" )] = date( "YmdThi".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["YmdThi".GetMessage( "DATA_EXPORTPRO_1" )] = date( "YmdThi".GetMessage( "DATA_EXPORTPRO_1" ), time() );
$time["Y-m-dTh:i".GetMessage( "DATA_EXPORTPRO_" )] = date( "Y-m-dTh:i".GetMessage( "DATA_EXPORTPRO_" ), time() );
$time["Y-m-dTh:i".GetMessage( "DATA_EXPORTPRO_2" )] = date( "Y-m-dTh:i".GetMessage( "DATA_EXPORTPRO_2" ), time() );
...
function DataExportproGetDefaultSelectedStep4( $schemeValue, $arProfileValue ){
...
<tr class="heading" align="center">
	<td colspan="2"><b><?=GetMessage( "DATA_EXPORTPRO_SCHEME_DETAIL" );?></b></td>
</tr>
<tr align="center">
	<td colspan="2">
		<?=BeginNote();?>
		<?=GetMessage( "DATA_EXPORTPRO_SCHEME_DETAIL_DESCRIPTION" );?>
		<?=EndNote();?>
	</td>
</tr>
<tr>
    <td width="50%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[DATEFORMAT]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[DATEFORMAT]' ), '<?=GetMessage( "DATA_EXPORTPRO_SCHEME_DATEFORMAT_HELP" )?>' );</script>
        <label for="PROFILE[DATEFORMAT]"><b><?=GetMessage( "DATA_EXPORTPRO_SCHEME_DATEFORMAT" );?></b></label>
    </td>
...
<tr>
    <td width="50%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[SITE_PROTOCOL]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[SITE_PROTOCOL]' ), '<?=GetMessage( "DATA_EXPORTPRO_SCHEME_SITE_PROTOCOL_HELP" )?>' );</script>
        <label for="PROFILE[SITE_PROTOCOL]"><b><?=GetMessage( "DATA_EXPORTPRO_SCHEME_SITE_PROTOCOL" )?></b></label>
    </td>
    <td width="" class="adm-detail-content-cell-r">
...
<tr>
    <td width="50%">
        <span id="hint_PROFILE[EXPORT_PARENT_CATEGORIES]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[EXPORT_PARENT_CATEGORIES]' ), '<?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_PARENT_CATEGORIES_HELP" )?>' );</script>
        <label for="PROFILE[EXPORT_PARENT_CATEGORIES]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_PARENT_CATEGORIES" );?></label>
    </td>
    <td><input type="checkbox" name="PROFILE[EXPORT_PARENT_CATEGORIES]" value="Y" <?=$bExportParentCategories?> ></td>
</tr>
<tr>
    <td width="50%">
        <span id="hint_PROFILE[EXPORT_PARENT_CATEGORIES_TO_OFFER]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[EXPORT_PARENT_CATEGORIES_TO_OFFER]' ), '<?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_PARENT_CATEGORIES_TO_OFFER_HELP" )?>' );</script>
        <label for="PROFILE[EXPORT_PARENT_CATEGORIES_TO_OFFER]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_PARENT_CATEGORIES_TO_OFFER" );?></label>
    </td>
    <td><input type="checkbox" name="PROFILE[EXPORT_PARENT_CATEGORIES_TO_OFFER]" value="Y" <?=$bExportParentCategoriesToOffer?> ></td>
</tr>
<tr>
    <td width="50%">
        <span id="hint_PROFILE[EXPORT_OFFER_CATEGORIES_TO_OFFER]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[EXPORT_OFFER_CATEGORIES_TO_OFFER]' ), '<?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_OFFER_CATEGORIES_TO_OFFER_HELP" )?>' );</script>
        <label for="PROFILE[EXPORT_OFFER_CATEGORIES_TO_OFFER]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_OFFER_CATEGORIES_TO_OFFER" );?></label>
    </td>
    <td><input type="checkbox" name="PROFILE[EXPORT_OFFER_CATEGORIES_TO_OFFER]" value="Y" <?=$bExportOfferCategoriesToOffer?> ></td>
</tr>
<tr>
    <td width="50%">
        <span id="hint_PROFILE[EXPORT_PARENT_CATEGORIES_WITH_IBLOCK_FIELDS]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[EXPORT_PARENT_CATEGORIES_WITH_IBLOCK_FIELDS]' ), '<?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_PARENT_CATEGORIES_WITH_IBLOCK_FIELDS_HELP" )?>' );</script>
        <label for="PROFILE[EXPORT_PARENT_CATEGORIES_WITH_IBLOCK_FIELDS]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_EXPORT_PARENT_CATEGORIES_WITH_IBLOCK_FIELDS" );?></label>
    </td>
...
<tr class="heading">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_SELECT" )?></td>
</tr>
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][NAME]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA" )?></label>
    </td>
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][PREVIEW_TEXT]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_PREVIEWTEXT" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][DETAIL_TEXT]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_DETAILTEXT" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][DETAIL_PICTURE]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_DETAILPICTURE" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][CATALOG_QUANTITY]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_QUANTITY" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][CATALOG_QUANTITY_RESERVED]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_QUANTITY_RESERVED" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][CATALOG_WEIGHT]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_WEIGHT" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][CATALOG_WIDTH]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_WIDTH" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][CATALOG_LENGTH]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_LENGTH" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][CATALOG_HEIGHT]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_HEIGHT" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <label for="PROFILE[NAMESCHEMA][CATALOG_PURCHASING_PRICE]"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_PURCHASING_PRICE" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr class="heading">
	<td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_TAGS" )?></td>
</tr>
<tr>
	<td align="center" colspan="2">
		<div class="adm-info-message"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_FULLDESC" )?></div>
	</td>
</tr>

<tr class="heading">
	<td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_ALL" )?></td>
</tr>
<tr align="center">
	<td colspan="2">
		<?=BeginNote();?>
		<?=GetMessage( "DATA_EXPORTPRO_SCHEME_MAIN_DESCRIPTION" )?>
		<br>
...
<tr class="heading">
	<td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_OFFER" )?></td>
</tr>
<tr align="center">
	<td colspan="2">
		<?=BeginNote();?>
		<?=GetMessage( "DATA_EXPORTPRO_SCHEME_TAGS_DESCRIPTION" );?>
...
<tr class="heading">
	<td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_CATEGORY" )?></td>
</tr>
<tr align="center">
	<td colspan="2">
		<?=BeginNote();?>
		<?=GetMessage( "DATA_EXPORTPRO_SCHEME_CATEGORY_DESCRIPTION" );?>
		<?=EndNote();?>
	</td>
</tr>
<tr>
...
<tr class="heading">
	<td colspan="2"><?=GetMessage( "DATA_EXPORTPRO_SCHEME_CURRENCY" )?></td>
</tr>
<tr align="center">
	<td colspan="2">
		<?=BeginNote();?>
		<?=GetMessage( "DATA_EXPORTPRO_SCHEME_CURRENCY_DESCRIPTION" );?>
		<?=EndNote();?>
	</td>
</tr>
<tr>
